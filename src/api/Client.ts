...
export class Client {
    ...
    protected processGetInformation(response: Response): Promise<User> {
        ...
        if (status === 200) {
            ...
            result404 = InternalError.fromJS(resultData404);
     ...
     * @return Ok
     */
    getAudioHandlers(): Promise<Anonymous6[]> {
    ...
    protected processGetAudioHandlers(response: Response): Promise<Anonymous6[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Ok
     */
    getLightsHandlers(): Promise<Anonymous7[]> {
    ...
    protected processGetLightsHandlers(response: Response): Promise<Anonymous7[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Ok
     */
    getScreenHandlers(): Promise<Anonymous8[]> {
    ...
    protected processGetScreenHandlers(response: Response): Promise<Anonymous8[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Ok
     */
    spotifyLoginCallback(state: string, code: string | undefined, error: string | undefined): Promise<Anonymous9> {
    ...
    protected processSpotifyLoginCallback(response: Response): Promise<Anonymous9> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
